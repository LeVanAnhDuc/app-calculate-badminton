import { formatDateLabel, formatFilenameDate, renderResultImage } from './exportImage'
...
describe('chi phí phát sinh khác', () => {
  ...
  // 20
  test('extras do not change the canvas height — the note is appended to the existing line', () => {
    stubCanvas()
